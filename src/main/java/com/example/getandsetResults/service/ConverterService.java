...
/*    public Document createReport(OrderResponse orderResponse) throws IOException {
        String path = orderResponse.time().toString().substring(0, 10) + orderResponse.surname_() + ".pdf";
        ...
        resultTable.setTextAlignment(TextAlignment.CENTER)
                .setFontSize(8)
                .setBold();
        resultTable.addCell(new Cell().add("Analysis name"));
        resultTable.addCell(new Cell().add("Result"));
        resultTable.addCell(new Cell().add("Description"));
